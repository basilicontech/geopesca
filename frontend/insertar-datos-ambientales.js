...
async function cargarDatosAmbientales(prefix = '') {
  try {
    ...
    // Hábitats
    const habitats = await fetch("http://localhost:3000/api/catalogs/habitats").then(r => r.json());
    ...
    // Tipos de lecho
    const lechos = await fetch("http://localhost:3000/api/catalogs/tipos-lecho").then(r => r.json());
    ...
    const vientos = await fetch("http://localhost:3000/api/catalogs/direcciones-viento").then(r => r.json());
    ...
    const velocidades = await fetch("http://localhost:3000/api/catalogs/velocidades-viento").then(r => r.json());
    ...
    // Alturas de olas
    const olas = await fetch("http://localhost:3000/api/catalogs/alturas-olas").then(r => r.json());
    ...
    // Turbideces
    const turbideces = await fetch("http://localhost:3000/api/catalogs/turbideces").then(r => r.json());
    ...
    const tiempos = await fetch("http://localhost:3000/api/catalogs/tiempos-atmosfericos").then(r => r.json());
    ...
    if (esJornada) {
      // Tipo de pesca
      const pescas = await fetch("http://localhost:3000/api/catalogs/tipos-pesca").then(r => r.json());
      ...
      // Cebos naturales
      const cebosNat = await fetch("http://localhost:3000/api/catalogs/cebos-naturales").then(r => r.json());
      ...
      // Cebos artificiales
      const cebosArt = await fetch("http://localhost:3000/api/catalogs/cebos-artificiales").then(r => r.json());
