...
async function cargarDatosAmbientales(prefix = '') {
  try {
    ...
    // Hábitats
    const habitats = await fetch("https://geopesca.basilicontech.com/api/catalogs/habitats").then(r => r.json());
    ...
    // Tipos de lecho
    const lechos = await fetch("https://geopesca.basilicontech.com/api/catalogs/tipos-lecho").then(r => r.json());
    ...
    const vientos = await fetch("https://geopesca.basilicontech.com/api/catalogs/direcciones-viento").then(r => r.json());
    ...
    const velocidades = await fetch("https://geopesca.basilicontech.com/api/catalogs/velocidades-viento").then(r => r.json());
    const velocidadSelect = document.getElementById(`${prefix}velocidad_viento`);
    if (velocidadSelect) {
    ...
    // Alturas de olas
    const olas = await fetch("https://geopesca.basilicontech.com/api/catalogs/alturas-olas").then(r => r.json());
    ...
    // Turbideces
    const turbideces = await fetch("https://geopesca.basilicontech.com/api/catalogs/turbideces").then(r => r.json());
    ...
    const tiempos = await fetch("https://geopesca.basilicontech.com/api/catalogs/tiempos-atmosfericos").then(r => r.json());
    ...
    if (esJornada) {
      // Tipo de pesca
      const pescas = await fetch("https://geopesca.basilicontech.com/api/catalogs/tipos-pesca").then(r => r.json());
      ...
      // Cebos naturales
      const cebosNat = await fetch("https://geopesca.basilicontech.com/api/catalogs/cebos-naturales").then(r => r.json());
      ...
      // Cebos artificiales
      const cebosArt = await fetch("https://geopesca.basilicontech.com/api/catalogs/cebos-artificiales").then(r => r.json());
...
function obtenerDatosAmbientales(prefix = '') {
  ...
  const datos = {
    id_habitat: parseInt(document.getElementById(`${prefix}habitat`)?.value) || null,
    id_tipo_lecho: parseInt(document.getElementById(`${prefix}tipo_lecho`)?.value) || null,
    algas_presente: document.getElementById(`${prefix}algas`)?.value === "true" ? true : 
                    document.getElementById(`${prefix}algas`)?.value === "false" ? false : null,
    id_direccion_viento: parseInt(document.getElementById(`${prefix}direccion_viento`)?.value) || null,
    id_velocidad_viento: parseInt(document.getElementById(`${prefix}velocidad_viento`)?.value) || null,
    id_altura_olas: parseInt(document.getElementById(`${prefix}altura_olas`)?.value) || null,
    id_turbidez: parseInt(document.getElementById(`${prefix}turbidez`)?.value) || null,
    id_tiempo_atmosferico: parseInt(document.getElementById(`${prefix}tiempo`)?.value) || null,
    mar_fondo: document.getElementById(`${prefix}mar_fondo`)?.value === "true" ? true :
               document.getElementById(`${prefix}mar_fondo`)?.value === "false" ? false : null
  };

  // Si es jornada, añadir campos específicos de pesca
  if (esJornada) {
    datos.id_tipo_pesca = parseInt(document.getElementById("tipo_pesca")?.value) || null;
    datos.id_cebo_natural = parseInt(document.getElementById("cebo_natural")?.value) || null;
    datos.id_cebo_artificial = parseInt(document.getElementById("cebo_artificial")?.value) || null;
